      ...
      <div className={this.props.data.showAttribution ? 'visible attr-container' : 'attr-container'} onClick={this.hide}>
        <div id='attr-info'>
          <div>
            ...
            <p><strong>Place search API </strong>by <a href='https://mapzen.com/documentation/search/' target='_blank'>Mapzen</a>. Data by NASA/JPL, USGS, and others.</p>

            <p><strong>Elevation data</strong> by <a href='https://mapzen.com/documentation/elevation/' target='_blank'>Mapzen</a>. Data derived from SRTM, ETOPO, and NED.</p>
            ...
            <p><strong>Code </strong>by <a href='https://macrostrat.org' target='_blank'>Macrostrat</a>, under <a href='http://creativecommons.org/licenses/by/4.0/' target='_blank'>CC-BY 4.0</a>, and can be found <a href='https://github.com/UW-Macrostrat/burwell-app' target='_blank'>on Github</a>.</p>
            ...
            <p><strong>Funding </strong> for core <a href='https://macrostrat.org'>Macrostrat</a> development via NSF EAR-1150082, Macrostrat&mdash;geologic map integration via NSF ICER-1440312, and literature integration via NSF ICER-1343760.</p>
            ...
            <p><strong>Index map: </strong> all geologic map sources can be found at <a href='https://macrostrat.org/map/sources'>https://macrostrat.org/map/sources</a></p>
          </div>
        </div>
      </div>
    );
